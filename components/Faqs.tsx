...
export default function Faqs({ background = false }: { background?: boolean }) {
  return (
    <section
      id="faq"
      className={`py-18 ${background ? "bg-white" : "bg-body-gray"}`}
    >
      <div className="container mx-auto px-4 flex">
        <div className="flex-1 flex flex-col items-start gap-6">
          ...
          <TextAnimate
            ...
            startOnView
            once
            className="text-lg md:text-4xl text-foreground font-medium"
          >
        ...
        <div className="flex-1">
          ...
          >
            <AccordionItem value="item-1">
              <AccordionTrigger
                className={`hover:no-underline text-left p-6 ${background ? "bg-body-gray" : ""}`}
              >
                What is RideFlow?
              </AccordionTrigger>
              <AccordionContent
                className={`text-muted-foreground p-6 ${background ? "bg-body-gray" : ""}`}
              >
