      ...
      <div className="container mx-auto px-6 flex text-center flex-col items-center justify-center gap-6 md:gap-8 h-full">
        ...
        <div className="flex flex-col gap-4 md:gap-6 items-center">
          <TextAnimate
            ...
            startOnView
            once
            className="text-2xl sm:text-3xl md:text-[2.6rem] font-medium w-full md:w-[90%] lg:w-[78%]"
          >
          ...
          <TextAnimate
            ...
            startOnView
            once
            className="text-base md:text-lg text-rideflow-text w-full md:w-[80%] lg:w-[60%]"
          >
