...
const Hero = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center pb-0 pt-2 md:pt-10 gap-6">
      <div className="flex flex-col-reverse md:flex-col items-center justify-center gap-20 max-w-4xl">
